...
# Testing
# x <- total_fires(raster_stack = burned_rasters_reordered, start_year = 2010, num_years = 1)
# terra::plot(x)
# 
# y <- total_fires(raster_stack = burned_rasters_reordered, start_year = 2014, num_years = 3)
...
# 
# z <- total_fires(raster_stack = burned_rasters_reordered, start_year = 2012, num_years = 10)
...
total_fires_1978_2023 <- total_fires(raster_stack = burned_rasters_reordered, start_year = 1978, num_years = 45)
# Check plot
